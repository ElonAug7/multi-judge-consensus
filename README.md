...
- **Value-operation safety gate (v0.8.0)** — after pilot C6 showed a both-producers-agree block
  can still gut a *correct* value when the committee false-rejects, only net **value→value replacements**
